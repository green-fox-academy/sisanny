//Today your job is to create the backend part of the application for an existing frontend app provided as an HTML and JavaScript file below.
//
...
//    Download the frontend.js and the index.html file from here and place it under your project
...
//    If you see a nice page where you can test the following exercises, proceed to the next one.
